...
class PrincipalsControllerTest < ActionController::TestCase
  ...
  test "should create principal" do
    assert_difference('Principal.count') do
      post :create, principal: { biography: @principal.biography, first: @principal.first, last: @principal.last, name: @principal.name, name: @principal.name, titles: @principal.titles }
    end
  ...
  test "should update principal" do
    patch :update, id: @principal, principal: { biography: @principal.biography, first: @principal.first, last: @principal.last, name: @principal.name, name: @principal.name, titles: @principal.titles }
    assert_redirected_to principal_path(assigns(:principal))
  end
